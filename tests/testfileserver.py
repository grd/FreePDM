...
if __name__ == "__main__":
    ...
    i = fs.import_new_file(file4, "ConceptOfDesign/TestFiles", "")
    print("Import Nr: " + str(i))
    i = fs.import_new_file(file5, "ConceptOfDesign/TestFiles", "")
    print("Import Nr: " + str(i))
    i = fs.import_new_file(file6, "ConceptOfDesign/TestFiles", "")
    print("Import Nr: " + str(i))
    print(fs.listdir())
